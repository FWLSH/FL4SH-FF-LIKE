...
if __name__ == '__main__':
    print("🚀 Server started - All servers working!")
    print("📁 Account files:")
    print("   - account_ind.txt (IND server)")
    print("   - account_br.txt (BR/US/SAC/NA servers)")
    print("   - account_bd.txt (BD server)")
    print("🌍 Supported servers: IND, BR, US, SAC, NA, BD")
    print("🧠 Smart caching: Prevents duplicate likes")
    print("📝 Response format: Simple like second code")
